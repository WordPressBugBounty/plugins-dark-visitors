...
Demos can be found on the [home page](https://knownagents.com/).

## Further Details

This plugin connects your website to [Known Agents](https://knownagents.com/). It uses the Known Agents API to connect to your account and provide functionality.
...
1. Install and activate the Known Agents plugin from the WordPress Plugin Directory
2. [Sign up](https://knownagents.com/sign-up) for Known Agents and [create a new project](https://knownagents.com/projects) for your website.
...
Your website is now connected to Known Agents.
...
Known Agents tracks thousands of known AI agents, web crawlers, and scrapers by inspecting the user agent string and other signals on each request. This includes GPTBot (OpenAI), ClaudeBot (Anthropic), PerplexityBot, Googlebot, Bytespider (TikTok), CCBot (Common Crawl), and many more. See the full [agent directory](https://knownagents.com/agents) for the complete list.
...
= 1.21.0 =
* Added new agent types

= 1.20.0 =
* Screenshot and copy updates

= 1.19.0 =
* Code, design, screenshot, and copy updates
